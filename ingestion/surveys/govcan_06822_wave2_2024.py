"""Extractor for govcan_06822_wave2_2024.
Source: Government of Canada (Continuous Survey of Canadians)
Dictionary: 068-22-wave2-data-dictionary.xlsx
Data: 068-22-wave2-data.csv (CSV, UTF-8)
"""
...
SURVEY_ID = "govcan_06822_wave2_2024"
SURVEY_NAME = "Continuous Survey of Canadians (Wave 2, 2024)"
SURVEY_YEAR = 2024
...
EXCLUDED_VARS = {
    ...
    "OVERSAMPLE_YOUTH": "Sample metadata",
    ...
    "ROTSECT2": "Technical randomization flag",
    ...
    "AIMMIGRATE_YEAR": "Other (open text)",
    "ABIRTH_PLACE": "Other (open text)",
    "AETHNICITY": "Other (open text)",
    "ALANGUAGE": "Other (open text)",
    "AINTBARRIER": "Other (open text)",
    "Variables in the working file": "Header noise in dictionary",
}

# Add timing, ordering, and flag variables
for i in range(1, 11):
    EXCLUDED_VARS[f"ATSECT{i}AVG"] = "Technical timing metric"
EXCLUDED_VARS["ATENDAVG"] = "Technical timing metric"
for i in range(1, 3):
    EXCLUDED_VARS[f"ATBLOCK{i}AVG"] = "Technical timing metric"
    EXCLUDED_VARS[f"AORDERBLOCK{i}CALC"] = "Technical ordering metric"
for i in range(2, 9):
    EXCLUDED_VARS[f"AORDERSECT{i}CALC"] = "Technical ordering metric"

# Flags
for col in [
    "FLAGMIDI_ACCURACY_COV", "FLAGCON_COV", "FLAGMIDI_ACCURACY_CLI",
    "FLAGCON_CLI", "FLAGTRUST_FACET", "FLAGSOCMED", "FLAGINFO_USE",
    "FLAGSOURCE_FORMAT", "FLAGINFO_FEEL"
]:
