"""Extraction normalisée — provincial_qc_2018.

Source : IPsos_oct_2018_17-057727_V.SAV (SPSS)
         Sondage Panel Élections Provinciales Québec 2018, firme Ipsos.
         ...
         (25 %).
         Cf. « LivredeCodes_SondagePanelQC2018.pdf ».
...
Usage :
    uv run python ingestion/surveys/provincial_qc_2018.py
    → écrit ingestion/normalized/provincial_qc_2018.json
"""
...
DATA_DIR = REPO_ROOT / "data" / "provincial_qc_2018"
SAV_FILE = DATA_DIR / "IPsos_oct_2018_17-057727_V.SAV"
WEIGHT_VAR = "weight"  # poids fourni → weight_source='provided'
OUT_FILE = REPO_ROOT / "ingestion" / "normalized" / "provincial_qc_2018.json"

# ---------------------------------------------------------------------------
# Constantes du sondage
# ---------------------------------------------------------------------------

SURVEY_ID = "provincial_qc_2018"
SURVEY_NAME = "Sondage Panel Élections Provinciales Québec 2018"
YEAR = 2018
POLLSTER = "Ipsos"
LANGUAGE = "fr"
