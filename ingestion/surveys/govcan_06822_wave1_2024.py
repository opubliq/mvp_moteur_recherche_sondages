"""Extractor for govcan_06822_wave1_2024.
Source: Government of Canada (Continuous Survey of Canadians)
Dictionary: 068-22-wave1-data-dictionary.xlsx
Data: 068-22-wave1-data.csv (CSV, UTF-8)
"""
...
SURVEY_ID = "govcan_06822_wave1_2024"
SURVEY_NAME = "Continuous Survey of Canadians (Wave 1, 2024)"
SURVEY_YEAR = 2024
POLLSTER = "Government of Canada"
LANGUAGE = "en"

DATA_DIR = Path("data") / SURVEY_ID
CSV_FILE = DATA_DIR / "068-22-wave1-data.csv"
WEIGHT_VAR = "wgt1"  # poids fourni → weight_source='provided' (v33.3)
XLSX_FILE = DATA_DIR / "068-22-wave1-data-dictionary.xlsx"
...
EXCLUDED_VARS = {
    ...
    "ATTCHECK2": "Attention check",
    "ATTCHECK4": "Attention check",
    "GENDER": "Missing labels in dictionary",
...
# Add timing and ordering variables to EXCLUDED_VARS
for i in range(1, 8):
