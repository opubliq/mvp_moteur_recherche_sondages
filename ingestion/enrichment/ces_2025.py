...
QUESTIONS = {
    ...
    "cps25_citizen_other": {
        "display_label": "Citizenship of another country",
        "concepts": ["citizenship", "dual citizenship"],
        "themes": ["demographics"],
    },
    "cps25_citizen_other2": {
        "display_label": "Other country of citizenship",
        "concepts": ["citizenship", "country of origin"],
        "themes": ["demographics"],
    },
    "cps25_citizen_other3": {
        "display_label": "List of all countries of citizenship",
        "concepts": ["citizenship", "dual citizenship"],
        "themes": ["demographics"],
    },
    "cps25_age_in_years": {
    ...
    "cps25_genderid_4_TEXT": {
        "display_label": "Gender identity (other specification text)",
        "concepts": ["gender identity", "demographics"],
        "themes": ["demographics"],
    },
    "cps25_trans": {
    ...
    "cps25_imp_iss_party_6_TEXT": {
        "display_label": "Party best at addressing issue (other party text)",
        "concepts": ["issue ownership", "party competence"],
    ...
    "cps25_howvote1": {
        "display_label": "Most likely method of voting",
        "concepts": ["voting method", "advance polling"],
        "themes": ["elections", "voting"],
    },
    "cps25_howvote2": {
        "display_label": "Voting method used",
        "concepts": ["voting method", "past voting behavior"],
        "themes": ["elections", "voting"],
    },
    "cps25_howvote3": {
        "display_label": "Expected voting method",
        "concepts": ["voting method", "mail-in voting"],
        "themes": ["elections", "voting"],
    },
    "cps25_votechoice": {
    ...
    "cps25_votechoice_pr": {
        "display_label": "Federal vote choice if eligible to vote",
        "concepts": ["vote choice", "hypothetical vote"],
        "themes": ["elections", "parties"],
    },
    "cps25_votechoice_pr_6_TEXT": {
        "display_label": "Federal vote choice if eligible to vote (other party text)",
        "concepts": ["vote choice", "hypothetical vote"],
        "themes": ["elections", "parties"],
    },
    "cps25_vote_unlikely": {
    ...
    "cps25_not_vote_for_1": {
        "display_label": "Parties respondent would absolutely not vote for (Liberal)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_2": {
        "display_label": "Parties respondent would absolutely not vote for (Conservative)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    ...
    "cps25_not_vote_for_4": {
        "display_label": "Parties respondent would absolutely not vote for (Bloc)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_5": {
        "display_label": "Parties respondent would absolutely not vote for (Green)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    ...
    "cps25_not_vote_for_6": {
        "display_label": "Parties respondent would absolutely not vote for (PPC)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_7": {
        "display_label": "Parties respondent would absolutely not vote for (Other)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    ...
    "cps25_not_vote_for_6_TEXT": {
        "display_label": "Parties respondent would absolutely not vote for (other text)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_w_1": {
        "display_label": "Reasons for not voting for specific parties (Leaders)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_w_2": {
        "display_label": "Reasons for not voting for specific parties (Policies)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_w_3": {
        "display_label": "Reasons for not voting for specific parties (Ideology)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_w_4": {
        "display_label": "Reasons for not voting for specific parties (Track record)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_w_5": {
        "display_label": "Reasons for not voting for specific parties (Other)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    "cps25_not_vote_for_w_4_TEXT": {
        "display_label": "Reasons for not voting for specific political parties (text)",
        "concepts": ["negative voting", "party rejection"],
        "themes": ["elections", "parties"],
    },
    ...
    "cps25_fed_gov_sat": {
        "display_label": "Satisfaction with federal government under Justin Trudeau",
        "concepts": ["government satisfaction", "trudeau government"],
        "themes": ["elections", "government"],
    },
    "cps25_fed_gov_sat_2": {
        "display_label": "Satisfaction with federal government performance",
        "concepts": ["government satisfaction", "federal government"],
        "themes": ["elections", "government"],
    },
    ...
    "cps25_employment_12_TEXT": {
        "display_label": "Employment status (other specification text)",
        "concepts": ["employment", "demographics"],
        "themes": ["demographics", "work"],
    },
    "cps25_sector": {
