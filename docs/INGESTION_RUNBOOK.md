...
- **16 sondages** dans l'index **public** `survey-questions`, ~3506 docs
  ...
  `eeq_2008`, `eeq_2014`, `eeq_2018`, `govcan_06822_wave1_2024`, `govcan_06822_wave2_2024`,
  `govcan_06822_wave3_2024`, `govcan_habit_2024`, `govcan_parca_2024`.
  Rail microdonnées Parquet également fait pour `eeq_2007`, `eeq_2008` et `eeq_2018` (poids
